        ...
        <div class="slider-container">
            <div class="slider-children clearfix">
                <div class="slides pull-right">
                    <img src="{{url('/img/slider/slide-1.png')}}" alt="slide 1">
                </div>
                <div class="controls pull-left">
                    <ul class="clearfix controls-btns">
                        <li data-img="{{url('/img/slider/slide-1.png')}}" data-bg_img="assets/img/slider/bg-btn1.png" class="active"><span><img src="assets/img/slider/list-img.png" alt="list-img-1"></span>50% Discount Insanity</li>
